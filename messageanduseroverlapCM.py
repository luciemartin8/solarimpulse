...
def determine_relevancy(user_relevancy, message_relevancy):
    # Pass Criteria
    if user_relevancy == 1 and message_relevancy == 1:
        return 1
    if user_relevancy == 1 and message_relevancy == 0:
        return 1
        
    # Fail Criteria
    if user_relevancy == 0 and message_relevancy == 1:
        return 0
    if user_relevancy == 0 and message_relevancy == 0:
        return 0
    
    # Handle 'N/A' cases
    if user_relevancy == 'N/A' or message_relevancy == 'N/A':
        return 'N/A'
...
def main():
    ...
    userdata = load_json_data("sortedbasedonprofileandmessage.json")
   ...
   # Determine overall predicted relevancy
    ...
    with open('classification_results_OP2.csv', 'w', newline='') as csvfile:
    ...
    print("Classification complete. Results saved in 'classification_results_OP2.csv'")
